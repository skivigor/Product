...
Item
{
    ...
    property bool  _powerSupplyUsed: settings.product.powerSupplyUsed         // use network PowerSupply (direct 220V)
    ...
    property bool  _fwSelectManual: settings.product.fwSelectManual           // select main STM firmware manual at FwCheck state
    //------------------------------------
    ...
    // Database objects
    property var     _objOrder: { "forder1c" : "", "forderdescription" : "", "fordereditems" : 0, "forderedinicount" : 0 }
    ...
    Component.onCompleted:
    {
        ...
        id_mainWindow._header = _args[0] + " : Restore"

//        var ret = _scanner.open(settings.scan.uart, settings.scan.speed)
//        if (ret === true)
//        {
//            avlog.show("green", "Scanner port opened ... OK")
//        } else
//        {
