...
#unix:!macx:CONFIG(debug, debug|release) : LIBS += -L$$PWD/AvUtilsLib/debug/ -lAvUtilsLib
#else:unix:!macx:CONFIG(release, debug|release) : LIBS += -L$$PWD/AvUtilsLib/release/ -lAvUtilsLib

#INCLUDEPATH += $$PWD/AvUtilsLib/include
#DEPENDPATH += $$PWD/AvUtilsLib/include

#unix:!macx:CONFIG(debug, debug|release) : PRE_TARGETDEPS += $$PWD/AvUtilsLib/debug/libAvUtilsLib.a
#else:unix:!macx:CONFIG(release, debug|release) : PRE_TARGETDEPS += $$PWD/AvUtilsLib/release/libAvUtilsLib.a
