...
void SerialClient::connectSerial(const QString &portName, int baudRate, const QString &parity, const QString &stopBits, const QString &flowCtrl)
{
    m_portName = portName;
    m_baudRate = baudRate;
...
void SerialClient::connectSerial(const QString &portName, int baudRate)
{
    m_portName = portName;
    m_baudRate = baudRate;
    ...
    if (m_port.isOpen()) return;
    connectSerial(portName, baudRate, "no", "1", "no");
}
